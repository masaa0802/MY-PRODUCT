                ...
                <div class="login-box">
                    ...
                    <div class="mt-3">
                        ...
                        <form method="POST" action="{{ action('Admin\UserController@update')}}" class="mt-4">
                            ...
                            <img src="{{ asset('storage/profiles/'.$user->avater) }}" id="img">
                            ...
                            {{-- <div>
                                <x-label for="avater" :value="__('プロフィール画像')" />
                                <x-input id="avater" class="block mt-1 mb-2 w-full" type="file"  name="avater" value="{{ $user->avater }}"  required autofocus />
                            </div> --}}
                            <div>
